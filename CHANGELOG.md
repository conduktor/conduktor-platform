...
- Admin
  ...
  - Kafka connect
  - New sidebar design, not collapsible and no icons
  - Clusters have a human friendly "technical id" that ease url sharing and co
  - Cluster creation/update design update to prepare the new flow with  
