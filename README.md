...
TODO: replace with proper URL/user/pass (fix default platform first)  

[https://demo.stg.apps.cdkt.dev/](https://demo.stg.apps.cdkt.dev/)  
User: `admin`  
Pass: `admin`

## Docker compose with embedded Kafka
